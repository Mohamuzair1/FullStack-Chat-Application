...
if %errorlevel%==0 (
    ...
    echo Run: scripts\start-backend-simple.bat
    echo.
    pause
    exit /b 1
)
...
echo Solution: Make sure backend is running (scripts\start-backend-simple.bat)
echo.
...
echo 1. Run: scripts\start-backend-simple.bat (wait for "Server is running")
echo 2. Run: scripts\start-frontend-simple.bat  
